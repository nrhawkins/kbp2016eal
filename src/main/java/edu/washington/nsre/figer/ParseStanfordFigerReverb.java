...
// line below did not work with WashingtonNewsSpikeExtractorApp
//	public static String configFile = "edu/washington/figer.conf";
//	public static String configFile = "/figer.conf";
//	public static String configFile = "/edu/washington/figer.conf";
// this works with getResourceAsStream(filename)
	public static String configFile = "figer.conf";
// works for the app - when X.parseArgs reads a File, changed that to readAsStream
//	public static String configFile = "../config/edu/washington/figer.conf";
	...
	private ParseStanfordFigerReverb() {
		...
		// read all tags
//                System.out.println("WNEA-PSFR: " + X.tagset);
...
//                        System.out.println("WNEA_PSFR: " + X.modelFile);
//                        System.out.println("WNEA PSFR: MODEL LOCATION: " + this.getClass().getResource(X.modelFile).getPath());
//                        model.readModel(this.getClass().getResource(X.modelFile).getPath());
	...
	public Mention buildMention(Annotation annotation, int sentId, int startToken, int endToken) {
		...
		String depStr = StanfordDependencyResolver.getString(sentAnn);
                //System.out.println("PSFR: depStr" + depStr);
	...
	static Gson gson = new Gson();
        ...
        public static List<FigerParsedSentence> process(String text) {

                List<FigerParsedSentence> fps = new ArrayList<FigerParsedSentence>();
        ...
        public static List<FigerParsedSentence> processKBP(Annotation annotation, ParseStanfordFigerReverb sys) {
        //public static List<FigerParsedSentence> processKBP(String text) {
        //public static List<FigerParsedSentence> processKBP(CoreMap sentence) {
        //public static List<FigerParsedSentence> process(String text) {
