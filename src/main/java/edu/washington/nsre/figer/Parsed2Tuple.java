	...
	public static List<Tuple> getReverbTuples(FigerParsedSentence s) {
		...
		for (int i = 0; i < s.blockNers.size(); i++) {
			...
			for (int j = 0; j < s.blockNers.size(); j++) {
                ...
                //System.out.println("-----------------------------------------------------");
                //System.out.println("P2T: s.reverbs: " + s.reverbs.size());
                //System.out.println("P2T: s.blockNers: " + s.blockNers.size());
                //System.out.println("P2T: argStartEnds: " + argStartEnds.size());
                //System.out.println("-----------------------------------------------------");
