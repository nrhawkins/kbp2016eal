...
//	public static String configFile = "config/figer.conf";
	...
	public static List<Pair<Integer, Integer>> getNamedEntityMentions(
        ...
        //Add this for integrating into DEFT Repository
        public static List<EntityMention> runMain(TokenStream tokenStream) {
		...
		String text = tokenStream.getTextValue();
                ...
                //System.out.println("FS: tokenStream num tokens: " + tokenStream.size());
...
//                                                + i
					...
					//create entity mention
                                        //System.out.println("FS: " + offset.first + "," + offset.second);
                                        TokenOffset tokenOffset = new TokenOffset(offset.first+sentNumTokens, offset.second+sentNumTokens-1); 
                                        //System.out.println("FS: " + tokenOffset.getBegin() + "," + tokenOffset.getEnd());
                                        EntityMention entityMention = new EntityMention(0, tokenOffset, tokenStream);
                                        entityMention.setMentionType(new Type("NAME"));
					entityMention.setSourceAlgorithm(new SourceAlgorithm("FIGER", "Washington"));
					entityMention.setEntityType(new Type(label));
                                        entityMentions.add(entityMention);
                                        //System.out.println("FS: " + label);
                                }
                                sentId++;

				List<CoreLabel> tokens = sentence.get(TokensAnnotation.class);
				//System.out.println("FS: numTokens: " + tokens.size());	
			        sentNumTokens = sentNumTokens + tokens.size();
				//System.out.println("FS: sentNumTokens" + sentNumTokens); 
